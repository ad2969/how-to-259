...
namespace CPSC259_2017W1_Lab2_UnitTests
{
  ...
  public:
    ...
    {
      // Let's test both negatives
      int first = -2;
      int second = -1289541;
      swap_ints(&first, &second);
      Assert::AreEqual(-1289541, first);
      Assert::AreEqual(-2, second);
    }

    TEST_METHOD(Test03_swap_ints_04)
    {
    ...
    TEST_METHOD(Test11_reverse_string_09)
    {
        // custom test
        char original[] = "xAdAwdsz";
        char reversed[] = "zsdwAdAx";
        reverse_string(original);
        Assert::AreEqual(0, strncmp(original, reversed, strlen(original)));
    }

    TEST_METHOD(Test11_reverse_string_10)
    {
        // custom test
        char original[] = " as as";
        char reversed[] = "sa sa ";
    ...
    TEST_METHOD(Test11_reverse_string_11)
    {
        // custom test
        char original[] = "   as  ";
        char reversed[] = "  sa   ";
    ...
    TEST_METHOD(Test11_reverse_string_12)
    {
        // custom test
        char original[] = "asdf  ";
        char reversed[] = "  fdsa";
    ...
    TEST_METHOD(Test11_reverse_string_13)
    {
        // custom test
        char original[] = ". ";
        char reversed[] = " .";
    ...
    TEST_METHOD(Test19_contains_sample_09)
    {
        // custom test
        char candidate[] = "125";
        char sample[] = "12";
    ...
    TEST_METHOD(Test19_contains_sample_10)
    {
        // custom test
        char candidate[] = "soooupspoospoon";
        char sample[] = "spoon";
        Assert::AreEqual(1, contains_sample(candidate, sample));
    }

    TEST_METHOD(Test19_contains_sample_11)
    {
        // custom test
        char candidate[] = "soooupspoospoon";
        char sample[] = "upp";
    ...
    TEST_METHOD(Test19_contains_sample_12)
    {
        // custom test
        char candidate[] = "soupy soup";
        char sample[] = "soup";
        Assert::AreEqual(1, contains_sample(candidate, sample));
    }

    TEST_METHOD(Test19_contains_sample_13)
    {
        // custom test
        char candidate[] = "soupy soup";
        char sample[] = " so";
    ...
    TEST_METHOD(Test19_contains_sample_14)
    {
        // custom test
        char candidate[] = "12 3456 7";
        char sample[] = "6 7";
        Assert::AreEqual(1, contains_sample(candidate, sample));
    }

    TEST_METHOD(Test19_contains_sample_15)
    {
        // custom test
        char candidate[] = "12 3456 7 ";
        char sample[] = " 7 ";
    ...
    TEST_METHOD(Test27_find_index_08)
    {
        // Let's conduct a positive test.  All strings
        // don't do anything, return -1
        char candidate[] = "";
        char sample[] = "soupspoon";
        Assert::AreEqual(-1, find_index(candidate, sample));
    }

    TEST_METHOD(Test27_find_index_09)
    {
        // custom test
        char candidate[] = "soupy soup";
        char sample[] = "soup";
    ...
    TEST_METHOD(Test27_find_index_10)
    {
        // custom test
        char candidate[] = "soupy soup";
        char sample[] = " so";
        Assert::AreEqual(5, find_index(candidate, sample));
    }

    TEST_METHOD(Test27_find_index_11)
    {
        // custom test
        char candidate[] = "12 3456 7";
        char sample[] = "6 7";
        Assert::AreEqual(6, find_index(candidate, sample));
    }

    TEST_METHOD(Test27_find_index_12)
    {
        // custom test
        char candidate[] = "12 3456 7 ";
        char sample[] = " 7 ";
        Assert::AreEqual(7, find_index(candidate, sample));
    }

    TEST_METHOD(Test27_find_index_13)
    {
        // custom test
        char candidate[] = "coriande";
        char sample[] = "coriander";
        Assert::AreEqual(-1, find_index(candidate, sample));
    }

    TEST_METHOD(Test27_find_index_14)
    {
        // custom test
        char candidate[] = "coriande  r";
        char sample[] = "coriande r";
        Assert::AreEqual(-1, find_index(candidate, sample));
    }
